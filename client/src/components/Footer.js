    ...
    <>
      <footer className="text-center text-lg-start bg-light text-muted">
        ...
        <section className="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
          ...
          <div className="me-5 d-none d-lg-block" style={{ color: '#008080' }}>
          ...
          <div>
            <a href="instagram.com" className="me-4 text-reset" style={{ color: '#008080' }}>
          ...
          <div className="container text-center text-md-start mt-5">
            ...
            <div className="row mt-3">
              ...
              <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                ...
                <h6 className="text-uppercase fw-bold mb-4" style={{ color: '#008080' }}>
                  <i className="fas fa-gem me-3" ></i>Tikiti Tamasha
                </h6>
                <p>
                  Unleash the Magic Within: Experience the Extraordinary
                </p>
              </div>
              ...
              <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                ...
                <h6 className="text-uppercase fw-bold mb-4" style={{ color: '#008080' }}>Contact</h6>
                <p><i className="fas fa-home me-3"></i> Nairobi,  10012, KENYA</p>
                <p>
                  <i className="fas fa-envelope me-3"></i>
                  tikititamasha@gmail.com
                </p>
        ...
        <div className="text-center p-4" style={{ color: '#008080' }}>
          © 2023 Copyright:
          <a className="text-reset fw-bold" href="https://github.com/derrickmomanyi/Group-3-Project">TIKITI TAMASHA</a>
        </div>
